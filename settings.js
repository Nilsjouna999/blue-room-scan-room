...
(function () {
  ...
  function secHow() {
    var body =
      ...
      lead("What is filed.", "Tarot draws, Concord bonds, and the Shelf’s open or sealed state are kept in this browser’s local storage — the same mechanism as the Motion setting on this page. They persist across visits to this device but go nowhere else: no server, no sync, no second device.") +
